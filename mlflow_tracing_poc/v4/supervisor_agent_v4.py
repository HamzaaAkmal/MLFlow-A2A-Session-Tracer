"""
V4 Supervisor Agent - TRUE Single Trace Multi-Turn Solution
============================================================

Uses start_span_no_context with parent_span parameter to ensure:
...
This achieves the TRUE single trace per session requirement.
"""
...
class SupervisorAgentV4:
    """
    Supervisor agent with TRUE single-trace multi-turn capability.
...
def demo():
    """Run a demo of the V4 single-trace solution."""
    print("\n" + "="*70)
    print("V4 SINGLE-TRACE MULTI-TURN DEMO")
    print("="*70)
    ...
    supervisor = SupervisorAgentV4()
    session_id = f"v4_session_{int(time.time())}"
    ...
    print("\nRun 'mlflow ui --port 5002 --backend-store-uri sqlite:///mlflow_v4.db'")
    print("="*70 + "\n")
