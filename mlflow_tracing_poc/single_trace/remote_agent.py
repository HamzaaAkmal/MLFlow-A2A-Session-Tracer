"""
Remote Agent - Returns work log for supervisor to trace
=======================================================

The remote agent performs tasks and returns a structured `work_log`
that the supervisor uses to create child spans in the session trace.
"""
